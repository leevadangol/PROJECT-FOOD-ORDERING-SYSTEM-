<?php
/*
    PASTA CATEGORY PAGE (pasta.php)
    Now DYNAMIC - reads all PASTA items from the database.
    Any food added via the admin panel with category="Pasta"
...
$sql    = "SELECT * FROM foods WHERE category = 'Pasta' ORDER BY f_id ASC";
    ...
    <div class="container">
      ...
      <?php else: ?>
        <p style="text-align:center; color:#888; padding:40px;">
          No PASTA items available at the moment.
        </p>
      <?php endif; ?>
