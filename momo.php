<?php
/*
    MOMO CATEGORY PAGE (momo.php)
    Now DYNAMIC - reads all MOMO items from the database.
    Any food added via the admin panel with category="Momo"
...
$sql    = "SELECT * FROM foods WHERE category = 'Momo' ORDER BY f_id ASC";
    ...
    <div class="container">
      ...
      <?php else: ?>
        <p style="text-align:center; color:#888; padding:40px;">
          No MOMO items available at the moment.
        </p>
      <?php endif; ?>
