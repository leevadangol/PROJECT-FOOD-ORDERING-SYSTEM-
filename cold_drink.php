<?php
/*
    COLD DRINKS CATEGORY PAGE (cold_drink.php)
    Now DYNAMIC - reads all COLD DRINKS items from the database.
    Any food added via the admin panel with category="Cold Drink"
...
$sql    = "SELECT * FROM foods WHERE category = 'Cold Drink' ORDER BY f_id ASC";
    ...
    <div class="container">
      ...
      <?php else: ?>
        <p style="text-align:center; color:#888; padding:40px;">
          No COLD DRINKS items available at the moment.
        </p>
      <?php endif; ?>
